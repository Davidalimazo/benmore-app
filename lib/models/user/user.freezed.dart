...
class _$UserImpl implements _User {
  const _$UserImpl(
      ...
      @HiveField(2) this.first_name,
      @HiveField(3) this.email,
      @HiveField(4) this.profile_picture,
      @HiveField(5) final List<String>? followers,
      @HiveField(6) final List<String>? posts,
  ...
  @override
  String toString() {
    return 'User(id: $id, username: $username, first_name: $first_name, email: $email, profile_picture: $profile_picture, followers: $followers, posts: $posts, createdAt: $createdAt, updatedAt: $updatedAt)';
  }
...
abstract class _User implements User {
  const factory _User(
      ...
      @HiveField(2) final String? first_name,
      @HiveField(3) final String? email,
      @HiveField(4) final String? profile_picture,
      @HiveField(5) final List<String>? followers,
      @HiveField(6) final List<String>? posts,
      @HiveField(7) final String? createdAt,
      @HiveField(8) final String? updatedAt}) = _$UserImpl;
