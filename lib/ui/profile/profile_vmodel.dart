...
class ProfileViewModel extends ReactiveViewModel {
  ...
  void viewPost({required DashboardItem dashboardItem}) => _navigationService
      .navigateTo(Routes.viewPost, arguments: {"dashboardItem": dashboardItem});

  void createPost() => _navigationService.navigateTo(Routes.createPost);

  void editPost({required DashboardItem dashboardItem}) => _navigationService
      .navigateTo(Routes.editPost, arguments: {"dashboardItem": dashboardItem});
