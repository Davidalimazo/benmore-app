...
import 'package:benmore/res/components/dialogs/delete_dialog.dart';
...
class EditPostView extends StatefulWidget {
  ...
  const EditPostView({super.key, required this.dashboardItem});
...
class _EditPostViewState extends State<EditPostView> {
  ...
  void initState() {
    super.initState();
    captionController =
        TextEditingController(text: widget.dashboardItem.caption);
  }
